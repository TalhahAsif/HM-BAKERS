...
const Layout = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-purple-50 via-white to-blue-50">
      ...
      <nav className={`z-50 flex items-center px-6 py-3 w-[75%] md:rounded-xl ${isMenuOpen ? "rounded-t-xl" : "rounded-xl"} backdrop-blur-xl shadow-xl bg-fuchsia-50/50`}> 
          <div className="flex items-center justify-between w-full gap-6">
            ...
            <div
              className={`absolute md:static top-full left-0 w-full md:w-auto md:flex items-center gap-5 p-4 md:p-0 rounded-b-lg transition-all duration-300 ease-in-out ${
